...
FILTER_ARGUMENT_TYPE_WARNING = '%s filter: Argument type (%s) was not expected'
FILTER_VALUE_TYPE_WARNING = '%s filter: Value type (%s) was not expected'
...
FILTER_LINEBREAKS_ERROR = 'linebreaks filter: ' + FILTER_GENERAL
FILTER_LINEBREAKSBR_ERROR = 'linebreaksbr filter: ' + FILTER_GENERAL
FILTER_LINENUMBERS_DEFAULT = 'linenumbers filter: Default value was used for argument %s'
